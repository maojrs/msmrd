...
namespace msmrd {
     ...
     * the core MSM approach. IMPORTANT: Need to define pointer to positionOrientationPartition  and
     ...
     * each with two patches an ang angleDiff away). The centers of the metastable regions are given by a tuple
     * of relative position and relative orientation. The size of the regions are determined by tolerancePosition and
