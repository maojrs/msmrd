...
# Given an MD simulation of dimers, generate discrete trajectories, using patchyDimer2 discrete trajectory.
...
discretizator = msmrd2.trajectories.patchyDimer2(numParticles, bufferSize)
